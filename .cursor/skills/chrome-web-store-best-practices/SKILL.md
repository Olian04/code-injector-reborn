...
Companion Cursor rule: `.cursor/rules/chrome-web-store.mdc` — **glob trigger
only** (frontmatter + pointer here / to [reference.md](reference.md)). Do not
duplicate checklist content in that `.mdc`; this skill is canonical.
